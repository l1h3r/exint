...
// CHECK-LABEL: define noundef i32 @band
...
// CHECK-LABEL: define noundef i32 @bor
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @bxor
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @bnot
...
// CHECK-LABEL: define noundef i32 @swap1
// CHECK-SAME: (i32 noundef %[[A:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @swap8
// CHECK-SAME: (i32 noundef %[[A:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @rotl
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
pub fn rotl(a: uint, b: u32) -> uint {
  // CHECK: %[[C:.+]] = tail call noundef i32 @llvm.fshl.i32(i32 %[[A]], i32 %[[A]], i32 %[[B]])
  // CHECK: ret i32 %[[C]]
  ::core::intrinsics::rotate_left(a, b)
}

// CHECK-LABEL: define noundef i32 @rotr
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
pub fn rotr(a: uint, b: u32) -> uint {
  // CHECK: %[[C:.+]] = tail call noundef i32 @llvm.fshr.i32(i32 %[[A]], i32 %[[A]], i32 %[[B]])
  // CHECK: ret i32 %[[C]]
...
pub fn ctpop(a: uint) -> u32 {
  // CHECK: %[[B:.+]] = tail call range(i32 0, 33) i32 @llvm.ctpop.i32(i32 %[[A]])
  // CHECK: ret i32 %[[B]]
...
pub fn ctlz(a: uint) -> u32 {
  // CHECK: %[[B:.+]] = tail call range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %[[A]], i1 false)
  // CHECK: ret i32 %[[B]]
...
pub fn ctlz_nonzero(a: uint) -> u32 {
  // CHECK: %[[B:.+]] = tail call range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %[[A]], i1 true)
  // CHECK: ret i32 %[[B]]
...
pub fn cttz_nonzero(a: uint) -> u32 {
  // CHECK: %[[B:.+]] = tail call range(i32 0, 33) i32 @llvm.cttz.i32(i32 %[[A]], i1 true)
  // CHECK: ret i32 %[[B]]
...
// CHECK-LABEL: define { i32, i1 } @overflowing_uadd
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
pub fn overflowing_uadd(a: uint, b: uint) -> (uint, bool) {
  // CHECK: %[[C:.+]] = add i32 %[[B]], %[[A]]
  // CHECK: %[[D:.+]] = icmp ult i32 %[[C]], %[[A]]
  // CHECK: %[[E:.+]] = insertvalue { i32, i1 } poison, i32 %[[C]], 0
  // CHECK: %[[F:.+]] = insertvalue { i32, i1 } %[[E]], i1 %[[D]], 1
  // CHECK: ret { i32, i1 } %[[F]]
  ::core::intrinsics::add_with_overflow(a, b)
}

// CHECK-LABEL: define { i32, i1 } @overflowing_usub
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef { i32, i1 } @overflowing_umul
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef { i32, i1 } @overflowing_sadd
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef { i32, i1 } @overflowing_ssub
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef { i32, i1 } @overflowing_smul
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @saturating_uadd
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @saturating_usub
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @saturating_sadd
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @saturating_ssub
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @unchecked_uadd
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @unchecked_usub
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @unchecked_umul
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @unchecked_udiv
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @unchecked_udiv_exact
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef range(i32 0, -1) i32 @unchecked_urem
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @unchecked_sadd
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @unchecked_ssub
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @unchecked_smul
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @unchecked_sdiv
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @unchecked_sdiv_exact
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef range(i32 -2147483647, -2147483648) i32 @unchecked_srem
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @unchecked_shl
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @unchecked_lshr
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @unchecked_ashr
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @unchecked_fshl
...
// CHECK-LABEL: define noundef i32 @unchecked_fshr
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]], i32 noundef %[[C:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @wrapping_add
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @wrapping_sub
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @wrapping_mul
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define noundef i32 @disjoint_bor
// CHECK-SAME: (i32 noundef %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
