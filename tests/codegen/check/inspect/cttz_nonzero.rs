...
pub fn int_9(a: int<9>) -> u32 {
  ...
  // CHECK: %[[C:.+]] = tail call range(i72 0, 73) i72 @llvm.cttz.i72(i72 %[[B]], i1 true)
...
pub fn int_10(a: int<10>) -> u32 {
  ...
  // CHECK: %[[C:.+]] = tail call range(i80 0, 81) i80 @llvm.cttz.i80(i80 %[[B]], i1 true)
...
pub fn int_11(a: int<11>) -> u32 {
  ...
  // CHECK: %[[C:.+]] = tail call range(i88 0, 89) i88 @llvm.cttz.i88(i88 %[[B]], i1 true)
...
pub fn int_12(a: int<12>) -> u32 {
  ...
  // CHECK: %[[C:.+]] = tail call range(i96 0, 97) i96 @llvm.cttz.i96(i96 %[[B]], i1 true)
...
pub fn int_14(a: int<14>) -> u32 {
  ...
  // CHECK: %[[C:.+]] = tail call range(i112 0, 113) i112 @llvm.cttz.i112(i112 %[[B]], i1 true)
...
pub fn int_15(a: int<15>) -> u32 {
  ...
  // CHECK: %[[C:.+]] = tail call range(i120 0, 121) i120 @llvm.cttz.i120(i120 %[[B]], i1 true)
