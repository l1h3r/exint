...
pub fn int_1(a: int<1>) -> u32 {
  // CHECK: %[[reg_a:.*]] = tail call range(i8 0, 9) i8 @llvm.cttz.i8(i8 %{{.*}}, i1 false)
...
pub fn int_2(a: int<2>) -> u32 {
  // CHECK: %[[reg_a:.*]] = tail call range(i16 0, 17) i16 @llvm.cttz.i16(i16 %{{.*}}, i1 false)
...
pub fn int_3(a: int<3>) -> u32 {
  // CHECK: %[[reg_a:.*]] = tail call range(i24 0, 25) i24 @llvm.cttz.i24(i24 %{{.*}}, i1 false)
...
pub fn int_4(a: int<4>) -> u32 {
  // CHECK: %[[reg:.*]] = tail call range(i32 0, 33) i32 @llvm.cttz.i32(i32 %{{.*}}, i1 false)
  // CHECK: ret i32 %[[reg]]
  a.trailing_zeros()
}
...
pub fn int_5(a: int<5>) -> u32 {
  // CHECK: %[[reg_a:.*]] = tail call range(i40 0, 41) i40 @llvm.cttz.i40(i40 %{{.*}}, i1 false)
...
pub fn int_6(a: int<6>) -> u32 {
  // CHECK: %[[reg_a:.*]] = tail call range(i48 0, 49) i48 @llvm.cttz.i48(i48 %{{.*}}, i1 false)
...
pub fn int_7(a: int<7>) -> u32 {
  // CHECK: %[[reg_a:.*]] = tail call range(i56 0, 57) i56 @llvm.cttz.i56(i56 %{{.*}}, i1 false)
...
pub fn int_8(a: int<8>) -> u32 {
  // CHECK: %[[reg_a:.*]] = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %{{.*}}, i1 false)
...
pub fn int_9(a: int<9>) -> u32 {
  ...
  // CHECK: %[[reg_b:.*]] = tail call range(i72 0, 73) i72 @llvm.cttz.i72(i72 %[[reg_a]], i1 false)
...
pub fn int_10(a: int<10>) -> u32 {
  ...
  // CHECK: %[[reg_b:.*]] = tail call range(i80 0, 81) i80 @llvm.cttz.i80(i80 %[[reg_a]], i1 false)
...
pub fn int_11(a: int<11>) -> u32 {
  ...
  // CHECK: %[[reg_b:.*]] = tail call range(i88 0, 89) i88 @llvm.cttz.i88(i88 %[[reg_a]], i1 false)
...
pub fn int_12(a: int<12>) -> u32 {
  ...
  // CHECK: %[[reg_b:.*]] = tail call range(i96 0, 97) i96 @llvm.cttz.i96(i96 %[[reg_a]], i1 false)
...
pub fn int_13(a: int<13>) -> u32 {
  ...
  // CHECK: %[[reg_b:.*]] = tail call range(i104 0, 105) i104 @llvm.cttz.i104(i104 %[[reg_a]], i1 false)
...
pub fn int_14(a: int<14>) -> u32 {
  ...
  // CHECK: %[[reg_b:.*]] = tail call range(i112 0, 113) i112 @llvm.cttz.i112(i112 %[[reg_a]], i1 false)
...
pub fn int_15(a: int<15>) -> u32 {
  ...
  // CHECK: %[[reg_b:.*]] = tail call range(i120 0, 121) i120 @llvm.cttz.i120(i120 %[[reg_a]], i1 false)
...
pub fn int_16(a: int<16>) -> u32 {
  ...
  // CHECK: %[[reg_b:.*]] = tail call range(i128 0, 129) i128 @llvm.cttz.i128(i128 %[[reg_a]], i1 false)
