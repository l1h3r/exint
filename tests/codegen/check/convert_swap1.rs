...
pub fn int_1(a: int<1>) -> int<1> {
  // CHECK: %[[reg:.*]] = tail call i8 @llvm.bitreverse.i8(i8 %{{.*}})
  // CHECK: ret i8 %[[reg]]
  a.reverse_bits()
}
...
pub fn int_2(a: int<2>) -> int<2> {
  // CHECK: %[[reg:.*]] = tail call i16 @llvm.bitreverse.i16(i16 %{{.*}})
  // CHECK: ret i16 %[[reg]]
  a.reverse_bits()
}
...
pub fn int_3(a: int<3>) -> int<3> {
  // CHECK: %[[reg:.*]] = tail call i24 @llvm.bitreverse.i24(i24 %{{.*}})
  // CHECK: ret i24 %[[reg]]
  a.reverse_bits()
}
...
pub fn int_4(a: int<4>) -> int<4> {
  // CHECK: %[[reg:.*]] = tail call i32 @llvm.bitreverse.i32(i32 %{{.*}})
  // CHECK: ret i32 %[[reg]]
  a.reverse_bits()
}
...
pub fn int_5(a: int<5>) -> int<5> {
  // CHECK: %[[reg:.*]] = tail call i40 @llvm.bitreverse.i40(i40 %{{.*}})
  // CHECK: ret i40 %[[reg]]
  a.reverse_bits()
}
...
pub fn int_6(a: int<6>) -> int<6> {
  // CHECK: %[[reg:.*]] = tail call i48 @llvm.bitreverse.i48(i48 %{{.*}})
  // CHECK: ret i48 %[[reg]]
  a.reverse_bits()
}
...
pub fn int_7(a: int<7>) -> int<7> {
  // CHECK: %[[reg:.*]] = tail call i56 @llvm.bitreverse.i56(i56 %{{.*}})
  // CHECK: ret i56 %[[reg]]
  a.reverse_bits()
}
...
pub fn int_8(a: int<8>) -> int<8> {
  // CHECK: %[[reg:.*]] = tail call i64 @llvm.bitreverse.i64(i64 %{{.*}})
  // CHECK: ret i64 %[[reg]]
  a.reverse_bits()
}
...
pub fn int_9(a: int<9>) -> int<9> {
  ...
  // CHECK: %[[reg_b:.*]] = tail call i72 @llvm.bitreverse.i72(i72 %[[reg_a]])
...
pub fn int_10(a: int<10>) -> int<10> {
  ...
  // CHECK: %[[reg_b:.*]] = tail call i80 @llvm.bitreverse.i80(i80 %[[reg_a]])
...
pub fn int_11(a: int<11>) -> int<11> {
  ...
  // CHECK: %[[reg_b:.*]] = tail call i88 @llvm.bitreverse.i88(i88 %[[reg_a]])
...
pub fn int_12(a: int<12>) -> int<12> {
  ...
  // CHECK: %[[reg_b:.*]] = tail call i96 @llvm.bitreverse.i96(i96 %[[reg_a]])
...
pub fn int_13(a: int<13>) -> int<13> {
  ...
  // CHECK: %[[reg_b:.*]] = tail call i104 @llvm.bitreverse.i104(i104 %[[reg_a]])
...
pub fn int_14(a: int<14>) -> int<14> {
  ...
  // CHECK: %[[reg_b:.*]] = tail call i112 @llvm.bitreverse.i112(i112 %[[reg_a]])
...
pub fn int_15(a: int<15>) -> int<15> {
  ...
  // CHECK: %[[reg_b:.*]] = tail call i120 @llvm.bitreverse.i120(i120 %[[reg_a]])
...
pub fn int_16(a: int<16>) -> int<16> {
  ...
  // CHECK: %[[reg_b:.*]] = tail call i128 @llvm.bitreverse.i128(i128 %[[reg_a]])
