...
pub fn ucmp(a: uint, b: uint) -> ::core::cmp::Ordering {
  // CHECK: %[[C:.+]] = tail call noundef range(i8 -1, 2) i8 @llvm.ucmp.i8.i16(i16 %[[A]], i16 %[[B]])
  // CHECK: ret i8 %[[C]]
...
pub fn scmp(a: int, b: int) -> ::core::cmp::Ordering {
  // CHECK: %[[C:.+]] = tail call noundef range(i8 -1, 2) i8 @llvm.scmp.i8.i16(i16 %[[A]], i16 %[[B]])
  // CHECK: ret i8 %[[C]]
...
// CHECK-LABEL: define range(i24 0, 131072) i24 @overflowing_uadd
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define range(i24 0, 131072) i24 @overflowing_usub
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define range(i24 0, 131072) i24 @overflowing_umul
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define range(i24 0, 131072) i24 @overflowing_sadd
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define range(i24 0, 131072) i24 @overflowing_ssub
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define range(i24 0, 131072) i24 @overflowing_smul
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @unchecked_uadd
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @unchecked_usub
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @unchecked_umul
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @unchecked_udiv
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @unchecked_udiv_exact
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define range(i16 0, -1) i16 @unchecked_urem
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @unchecked_sadd
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @unchecked_ssub
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @unchecked_smul
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @unchecked_sdiv
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @unchecked_sdiv_exact
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define range(i16 -32767, -32768) i16 @unchecked_srem
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @unchecked_shl
// CHECK-SAME: (i16 %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @unchecked_lshr
// CHECK-SAME: (i16 %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @unchecked_ashr
// CHECK-SAME: (i16 %[[A:.+]], i32 noundef %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @wrapping_add
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @wrapping_sub
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @wrapping_mul
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define i16 @disjoint_bor
// CHECK-SAME: (i16 %[[A:.+]], i16 %[[B:.+]])
#[unsafe(no_mangle)]
