...
// CHECK-LABEL: define range(i24 -8388607, -8388608) i24 @int_3
...
pub fn int_3(a: int<3>, b: int<3>) -> int<3> {
  ...
  // CHECK: ret i24 %[[F]]
  unsafe { exint::backend::unchecked_srem::<int<3>, 3>(a, b) }
}
...
// CHECK-LABEL: define range(i40 -549755813887, -549755813888) i40 @int_5
...
pub fn int_5(a: int<5>, b: int<5>) -> int<5> {
  ...
  // CHECK: ret i40 %[[F]]
  unsafe { exint::backend::unchecked_srem::<int<5>, 5>(a, b) }
}

// CHECK-LABEL: define range(i48 -140737488355327, -140737488355328) i48 @int_6
...
pub fn int_6(a: int<6>, b: int<6>) -> int<6> {
  ...
  // CHECK: ret i48 %[[F]]
  unsafe { exint::backend::unchecked_srem::<int<6>, 6>(a, b) }
}

// CHECK-LABEL: define range(i56 -36028797018963967, -36028797018963968) i56 @int_7
...
pub fn int_7(a: int<7>, b: int<7>) -> int<7> {
  ...
  // CHECK: ret i56 %[[F]]
  unsafe { exint::backend::unchecked_srem::<int<7>, 7>(a, b) }
}
...
pub fn int_9(a: int<9>, b: int<9>) -> int<9> {
  ...
  // CHECK: ret void
  unsafe { exint::backend::unchecked_srem::<int<9>, 9>(a, b) }
}
...
pub fn int_10(a: int<10>, b: int<10>) -> int<10> {
  ...
  // CHECK: ret void
  unsafe { exint::backend::unchecked_srem::<int<10>, 10>(a, b) }
}
...
pub fn int_11(a: int<11>, b: int<11>) -> int<11> {
  ...
  // CHECK: ret void
  unsafe { exint::backend::unchecked_srem::<int<11>, 11>(a, b) }
}
...
pub fn int_12(a: int<12>, b: int<12>) -> int<12> {
  ...
  // CHECK: ret void
  unsafe { exint::backend::unchecked_srem::<int<12>, 12>(a, b) }
}
...
pub fn int_13(a: int<13>, b: int<13>) -> int<13> {
  ...
  // CHECK: ret void
  unsafe { exint::backend::unchecked_srem::<int<13>, 13>(a, b) }
}
...
pub fn int_14(a: int<14>, b: int<14>) -> int<14> {
  ...
  // CHECK: ret void
  unsafe { exint::backend::unchecked_srem::<int<14>, 14>(a, b) }
}
...
pub fn int_15(a: int<15>, b: int<15>) -> int<15> {
  ...
  // CHECK: ret void
  unsafe { exint::backend::unchecked_srem::<int<15>, 15>(a, b) }
}
