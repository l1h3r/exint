...
if cfg!(target_endian = "big") {
    assert_eq!(Saturating::<u24>::from_ne_bytes([0x12, 0x34, 0x56]), Saturating(0x123456_u24));
} else {
    assert_eq!(Saturating::<u24>::from_ne_bytes([0x56, 0x34, 0x12]), Saturating(0x123456_u24));
}
# }
```
